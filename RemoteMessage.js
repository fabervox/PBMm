...
function initCode(){
    ...
    function module({
        ...
        let msgBtn = createPanelButton('https://raw.githubusercontent.com/EndlessNightNLR/endlessnightnlr.github.io/a6e947a7ecf86ca44782052e8b11890e5908db22/MLPP/msgIcon.png');
        ...
        let remoteMessage = new RemoteMessage({
        	src: 'https://raw.githubusercontent.com/caprallex/PBMm/master/msg.html',
        	interval: 60e3,
